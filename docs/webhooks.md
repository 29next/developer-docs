...
| -----------               | ------------------------------------ | ----- |
| `app.uninstalled`         | Triggers when an app is uninstalled. *Only available for apps.*| [View Example](/docs/admin-api/reference/#/webhooks/app.uninstalled/post) |
| `cart.abandoned`          | Triggers when a cart is marked as abandoned. | [View Example](/docs/admin-api/reference/#/webhooks/cart.abandoned/post) |
| `customer.created`        | Triggers when a new customer is created. | [View Example](/docs/admin-api/reference/#/webhooks/customer.created/post) |
| `customer.updated`        | Triggers when an existing customer is updated. | [View Example](/docs/admin-api/reference/#/webhooks/customer.updated/post) |
| `dispute.created`         | Triggers when a new dispute is created. | [View Example](/docs/admin-api/reference/#/webhooks/dispute.created/post) |
| `dispute.updated`         | Triggers when a dispute is updated. | [View Example](/docs/admin-api/reference/#/webhooks/dispute.updated/post) |
| `gateway.created`         | Triggers when a new gateway is created. | [View Example](/docs/admin-api/reference/#/webhooks/gateway.created/post) |
| `gateway.updated`         | Triggers when a gateway is updated. | [View Example](/docs/admin-api/reference/#/webhooks/gateway.updated/post) |
| `fulfillment.created`     | Triggers when a new fulfillment is created. | [View Example](/docs/admin-api/reference/#/webhooks/fulfillment.created/post) |
| `fulfillment.updated`     | Triggers when a fulfillment is updated. | [View Example](/docs/admin-api/reference/#/webhooks/fulfillment.updated/post) |
| `order.created`           | Triggers when an order is created. | [View Example](/docs/admin-api/reference/#/webhooks/order.created/post) |
| `order.updated`           | Triggers when an existing order is updated. | [View Example](/docs/admin-api/reference/#/webhooks/order.updated/post) |
| `product.created`         | Triggers when a product is created. | [View Example](/docs/admin-api/reference/#/webhooks/product.created/post) |
| `product.deleted`         | Triggers when an existing product is deleted. | [View Example](/docs/admin-api/reference/#/webhooks/product.deleted/post) |
| `product.updated`         | Triggers when an existing product is updated. | [View Example](/docs/admin-api/reference/#/webhooks/product.updated/post) |
| `transaction.created`     | Triggers when a payment transaction is created. | [View Example](/docs/admin-api/reference/#/webhooks/transaction.created/post) |
| `transaction.updated`     | Triggers when a payment transaction is updated. | [View Example](/docs/admin-api/reference/#/webhooks/transaction.updated/post) |
| `subscription.created`    | Triggers when a new subscription is created. | [View Example](/docs/admin-api/reference/#/webhooks/subscription.created/post) |
| `subscription.updated`    | Triggers when an existing subscription is updated. | [View Example](/docs/admin-api/reference/#/webhooks/subscription.updated/post) |
| `store.updated`           | Triggers when store settings are updated. | [View Example](/docs/admin-api/reference/#/webhooks/store.updated/post) |
| `ticket.created`          | Triggers a new support ticket is created. |  [View Example](/docs/admin-api/reference/#/webhooks/ticket.created/post) |
| `ticket.updated`          | Triggers when an existing support ticket is updated. | [View Example](/docs/admin-api/reference/#/webhooks/ticket.updated/post) |
...
Webhook object data structure follows the [Admin API](/docs/admin-api/index.md) and Admin API versioning to ensure predictable data structure for existing webhook receiver endpoints with a path for upgrades.
