...
Use [Webhooks](/webhooks.md) to subscribe to events and the [Admin API](/docs/admin-api/index.md) to add new logic and integrations, see the [Server to Server Guide](/docs/apps/guides/server-to-server-apps/).
