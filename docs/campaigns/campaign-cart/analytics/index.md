...
1. **Configure providers** - Set up GTM, Facebook Pixel, or other platforms
   ...
   See [Examples Overview](/docs/campaigns/campaign-cart/analytics/examples/)

2. **Learn tracking methods** - Understand the tracking API

   See [Tracking API Reference](/docs/campaigns/campaign-cart/analytics/tracking-api/)

3. **Review events** - See all standard e-commerce events

   See [Event Reference](/docs/campaigns/campaign-cart/analytics/events/)

4. **Advanced tracking** - Create custom events and use transform functions

   See [Custom Events](/docs/campaigns/campaign-cart/analytics/custom-events/)

## Documentation Structure

- **[Meta Tags](/docs/campaigns/campaign-cart/analytics/meta-tags/)** - Declarative analytics configuration via HTML meta tags
- **[Configuration & Modes](/docs/campaigns/campaign-cart/analytics/configuration/)** - Detailed configuration options
- **[Tracking API Reference](/docs/campaigns/campaign-cart/analytics/tracking-api/)** - Complete API documentation
- **[Examples](/docs/campaigns/campaign-cart/analytics/examples/)** - Provider-specific setup guides
- **[Event Reference](/docs/campaigns/campaign-cart/analytics/events/)** - Complete event schemas and examples
- **[Custom Events](/docs/campaigns/campaign-cart/analytics/custom-events/)** - Advanced tracking patterns
- **[Debugging](/docs/campaigns/campaign-cart/analytics/debugging/)** - Troubleshooting and testing
- **[Best Practices](/docs/campaigns/campaign-cart/analytics/best-practices/)** - Implementation patterns and tips
