...
- [Tracking API](/docs/campaigns/campaign-cart/analytics/tracking-api/) - Core tracking methods and events
- [Configuration](/docs/campaigns/campaign-cart/analytics/configuration/) - SDK configuration options
- [Examples](/docs/campaigns/campaign-cart/analytics/examples/) - Provider setup guides
