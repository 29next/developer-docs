...
In these cases, use Google Tag Manager instead. See [Google Tag Manager Setup](/docs/campaigns/campaign-cart/analytics/examples/google-tag-manager/).

## Build Your Own Transformer

Want to adapt this pattern for other platforms (TikTok, Snapchat, Pinterest)?

See **[Event Transformers](/docs/campaigns/campaign-cart/analytics/examples/event-transformers/)** for:
...
- **[Event Transformers](/docs/campaigns/campaign-cart/analytics/examples/event-transformers/)** - General pattern for any platform
- [Google Tag Manager Setup](/docs/campaigns/campaign-cart/analytics/examples/google-tag-manager/) - Alternative using GTM
- [Analytics Overview](/docs/campaigns/campaign-cart/analytics/) - Main analytics documentation
- [Event Reference](/docs/campaigns/campaign-cart/analytics/events/) - All available events
