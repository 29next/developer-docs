...
- **[Google Tag Manager](/docs/campaigns/campaign-cart/analytics/examples/google-tag-manager/)** - Container setup and variable configuration
- **[Facebook Pixel](/docs/campaigns/campaign-cart/analytics/examples/facebook-pixel/)** - Conversion tracking and audience building
- **[RudderStack](/docs/campaigns/campaign-cart/analytics/examples/rudderstack/)** - Data warehouse and CDP integration
- **[Custom Webhook](/docs/campaigns/campaign-cart/analytics/examples/custom-webhook/)** - Third-party API integration

### Alternative Integrations

- **[Direct GA4 (No GTM)](/docs/campaigns/campaign-cart/analytics/examples/direct-ga4/)** - Send events directly to Google Analytics 4 without GTM
- **[Event Transformers](/docs/campaigns/campaign-cart/analytics/examples/event-transformers/)** - Build custom transformers for any platform (TikTok, Snapchat, Pinterest, etc.)
- **[Custom Analytics Triggers](/docs/campaigns/campaign-cart/analytics/examples/custom-analytics-triggers/)** - Modify when `add_to_cart` and `begin_checkout` events fire
