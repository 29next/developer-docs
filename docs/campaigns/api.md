...
The Campaigns App provides an easy to use CORS enabled API that follows the best practices for integrating to our Admin API for an [External Checkout Flow](/docs/admin-api/guides/external-checkout.md).
...
<Link className="button button--primary button--lg" to="/docs/campaigns/api/reference/">See Campaigns API Reference</Link>
