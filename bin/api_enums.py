...
## Overview
Campaigns API is a headless API for campaign developers to easily create complex external campaign flows using Javascript, **no backend server-side integration required**.

Before using the Campaigns API, you'll need to install the Campaigns App and create a campaign to retrieve your campaign API Key.

## Authentication

Campaigns API uses uses unique Campaign API Key authentication to access campaign details and execute the checkout flow.
