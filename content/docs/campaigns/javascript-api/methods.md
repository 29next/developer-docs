...
For a complete list of all 34 available events, event data structures, initialization callbacks, and best practices, see the [Events Reference](/docs/campaigns/javascript-api/events).
