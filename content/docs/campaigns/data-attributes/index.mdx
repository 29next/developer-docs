...
<Cards>
  ...
  />
  <Card
    href="/docs/campaigns/data-attributes/profile"
    icon={<div className="size-9 rounded-md flex items-center justify-center bg-violet-500/15 text-violet-500"><User className="size-4" /></div>}
    title="Profile"
    description="Show or hide elements based on the active pricing profile."
  />
  <Card
