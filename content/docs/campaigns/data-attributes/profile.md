...
description: Display and control profile-based behavior and pricing
sidebar_position: 10
---
...
- [State Attributes](/docs/campaigns/data-attributes/state) - Profile conditionals
- [Configuration Attributes](/docs/campaigns/data-attributes/configuration) - Profile switcher configuration
- [Display Attributes](/docs/campaigns/data-attributes/display) - Display profile data
