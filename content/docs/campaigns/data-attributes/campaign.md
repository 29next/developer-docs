...
description: Display campaign-level information like name, currency, and language
sidebar_position: 11
---
...
- [Display Attributes](/docs/campaigns/data-attributes/display) - Display campaign data
- [State Attributes](/docs/campaigns/data-attributes/state) - Conditional display based on campaign
