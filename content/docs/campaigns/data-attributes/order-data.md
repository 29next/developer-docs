...
- [Display Attributes](/docs/campaigns/data-attributes/display) - Display dynamic data
- [State Attributes](/docs/campaigns/data-attributes/state) - Conditional display logic
- [Configuration Attributes](/docs/campaigns/data-attributes/configuration) - Formatting options
