...
<Link className="button button--primary button--lg" href="/docs/campaigns/api/reference/">See Campaigns API Reference</Link>
...
Bankcard payments require using the [iFrame Payment Form](/docs/admin-api/guides/iframe-payment-form) and passing the generated `card_token` for secure transfer of the payment method details. View a fully functional [Demo](https://29next.github.io/demo-iframe-payment-form/).
</Callout>
