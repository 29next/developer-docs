...
The enhancer adds and removes classes on the host element on every render to reflect the current cart state. Use these in CSS selectors to show or hide rows without JavaScript.
