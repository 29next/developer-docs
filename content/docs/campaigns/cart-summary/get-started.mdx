...
Add `data-next-cart-summary` to any container element. The enhancer subscribes to the cart store and re-renders the block automatically whenever totals change.
