...
See [Google Tag Manager Setup](/docs/campaigns/analytics/examples/google-tag-manager) for detailed configuration.
...
See [Facebook Pixel Setup](/docs/campaigns/analytics/examples/facebook-pixel) for event mapping and deduplication details.
...
See [RudderStack Setup](/docs/campaigns/analytics/examples/rudderstack) for event mapping details.
...
See [Custom Webhook Setup](/docs/campaigns/analytics/examples/custom-webhook) for batching, retry logic, and implementation details.
...
- [Tracking API Reference](/docs/campaigns/analytics/tracking-api) - Complete API documentation
- [Examples Overview](/docs/campaigns/analytics/examples) - Provider-specific setup guides
- [Event Reference](/docs/campaigns/analytics/events) - Complete event schemas
- [Debugging Guide](/docs/campaigns/analytics/debugging) - Troubleshooting and testing
