...
<Tabs items={['Newsletter', 'Video', 'Form', 'Feature']}>
...
<Tabs items={['Wishlist', 'Comparison', 'Quick View']}>
<Tab value="Wishlist">
...
<Tabs items={['Enrich Events', 'Filter Events', 'Privacy', 'Multi-Region']}>
<Tab value="Enrich Events">
...
- [Tracking API](/docs/campaigns/analytics/tracking-api) - Core tracking methods and events
- [Configuration](/docs/campaigns/analytics/configuration) - SDK configuration options
- [Examples](/docs/campaigns/analytics/examples) - Provider setup guides
