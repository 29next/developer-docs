...
See [Custom Events Guide](/docs/campaigns/analytics/custom-events) for advanced patterns and EventBuilder usage.
...
- [Configuration & Modes](/docs/campaigns/analytics/configuration) - Configure tracking modes and providers
- [Event Reference](/docs/campaigns/analytics/events) - Complete event schemas and examples
- [Custom Events](/docs/campaigns/analytics/custom-events) - Advanced tracking patterns with EventBuilder
