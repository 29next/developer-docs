...
<Callout type="idea">
This is a specific implementation of the general [Event Transformers](/docs/campaigns/analytics/examples/event-transformers) pattern. You can use the same approach for TikTok, Snapchat, Pinterest, or any other platform.
</Callout>
## When to Use This
...
In these cases, use Google Tag Manager instead. See [Google Tag Manager Setup](/docs/campaigns/analytics/examples/google-tag-manager).

## Build Your Own Transformer

Want to adapt this pattern for other platforms (TikTok, Snapchat, Pinterest)?

See **[Event Transformers](/docs/campaigns/analytics/examples/event-transformers)** for:
...
- **[Event Transformers](/docs/campaigns/analytics/examples/event-transformers)** - General pattern for any platform
- [Google Tag Manager Setup](/docs/campaigns/analytics/examples/google-tag-manager) - Alternative using GTM
- [Analytics Overview](/docs/campaigns/analytics) - Main analytics documentation
- [Event Reference](/docs/campaigns/analytics/events) - All available events
