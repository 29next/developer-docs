...
See [Reference → Attributes](./reference/attributes) for the full list of display bindings.
...
<div data-next-show="cart.totalQuantity == 1">Single item in cart</div>
<div data-next-show="cart.totalQuantity > 1">Multiple items in cart</div>
```

See [Reference → Attributes](./reference/attributes#cart-conditional-attributes) for all supported conditional expressions.
