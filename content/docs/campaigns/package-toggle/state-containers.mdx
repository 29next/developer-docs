...
The enhancer walks up the DOM from each card looking for a wrapper element that should receive state classes and attributes. This lets you style an outer section rather than the card element itself.
