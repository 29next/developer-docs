...
See [Google Tag Manager Setup](/docs/campaigns/campaign-cart/analytics/examples/google-tag-manager/) for detailed configuration.
...
See [RudderStack Setup](/docs/campaigns/campaign-cart/analytics/examples/rudderstack/) for event mapping details.
...
See [Custom Webhook Setup](/docs/campaigns/campaign-cart/analytics/examples/custom-webhook/) for batching, retry logic, and implementation details.
...
- [Examples Overview](/docs/campaigns/campaign-cart/analytics/examples/) - Provider-specific setup guides
- [Event Reference](/docs/campaigns/campaign-cart/analytics/events/) - Complete event schemas
- [Debugging Guide](/docs/campaigns/campaign-cart/analytics/debugging/) - Troubleshooting and testing
