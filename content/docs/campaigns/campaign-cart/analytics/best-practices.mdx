...
<Tabs items={['Action + Object', 'Object + Status', 'Object + Action + Context']}>
<Tab value="Action + Object">
...
<Tab value="Object + Action + Context">
...
<Tabs items={['Configuration', 'Best Practices']}>
...
<Tabs items={['Configuration', 'Implementation', 'Testing', 'Monitoring', 'Documentation']}>
<Tab value="Configuration">
