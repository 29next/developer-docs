...
See [Custom Events Guide](/docs/campaigns/campaign-cart/analytics/custom-events/) for advanced patterns and EventBuilder usage.
...
- [Configuration & Modes](/docs/campaigns/campaign-cart/analytics/configuration/) - Configure tracking modes and providers
- [Event Reference](/docs/campaigns/campaign-cart/analytics/events/) - Complete event schemas and examples
- [Custom Events](/docs/campaigns/campaign-cart/analytics/custom-events/) - Advanced tracking patterns with EventBuilder
