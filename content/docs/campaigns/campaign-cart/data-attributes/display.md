...
For a complete list of cart and item attributes plus a full checkout summary example, see [Cart Summary Checkout](/docs/campaigns/campaign-cart/guides/cart-summary-checkout).
