...
```json title="Update Existing Line Item" http-method="PATCH" http-target="https://{store}.29next.store/api/admin/orders/{number}/lines/{lineID}/"
{
...
```json title="Remove Line Item" http-method="DELETE" http-target="https://{store}.29next.store/api/admin/orders/{number}/lines/{lineID}/"
{}
```
...
```json title="Create New Line Item" http-method="POST" http-target="https://{store}.29next.store/api/admin/orders/{number}/lines/"
{
...
```json title="Collect Payment for Outstanding Balance" http-method="POST" http-target="https://{store}.29next.store/api/admin/orders/{number}/collect-payment/"
{
...
```json title="Retrieve Order Details" http-method="GET" http-target="https://{store}.29next.store/api/admin/orders/{number}/"
{
  "lines": [
    {
...
```json title="Refund Calculate Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/orders/{number}/refund/calculate/"
{
  "refund_lines": [
    {
...
```json title="Order Create Refund Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/orders/{number}/refund/"
{
...
```json title="Update Order Shipping Address" http-method="PATCH" http-target="https://{store}.29next.store/api/admin/orders/{number}/"
{
  "shipping_address": {
...
```json title="Fulfillment Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/fulfillment-request/"
{
...
```json title="Hold Fulfillment Order Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/hold/"
{
...
```json title="Fulfillment Order Cancellation Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/cancellation-request/"
{
...
```json title="Add Fulfillment Tracking" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/fulfillments/"
{
...
<Callout type="info" title="Multiple Tracking Numbers">
...
```json title="Cancel Order Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/orders/{number}/cancel/"
{
