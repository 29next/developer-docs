...
```json title="Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/carts/"
{
    "lines": [
        {
            "product_id": 1,
...
```json title="Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/orders/{number}/add-line-items/"
{
  "lines": [
        {
            "product_id": 2,
...
| [`link`](/docs/admin-api/guides/link) | Redirect | Yes | Yes | Yes |
| [`twint`](/docs/admin-api/guides/twint) | Redirect | No | Yes | Yes |
| [`affirm`](/docs/admin-api/guides/affirm) | Redirect | No | No | No |
