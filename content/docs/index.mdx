...
<Cards>
  <Card
    href="/docs/campaigns"
    icon={<div className="size-full rounded-md flex items-center justify-center bg-orange-500/15 text-orange-500"><Megaphone className="size-4" /></div>}
    title="Campaigns"
    description="Build campaign funnels and custom checkout experiences with the Campaign Cart SDK or Campaigns API."
  />
  <Card
    href="/docs/admin-api"
    icon={<div className="size-full rounded-md flex items-center justify-center bg-blue-500/15 text-blue-500"><ChevronsLeftRightEllipsis className="size-4" /></div>}
    title="Admin API"
  ...
  <Card
    ...
    icon={<div className="size-full rounded-md flex items-center justify-center bg-green-500/15 text-green-500"><ShoppingBag className="size-4" /></div>}
    title="Storefront"
    description="Customize your storefront theme, templates, and checkout flow using Theme Kit and the Storefront API."
  />
  <Card
    href="/docs/apps"
    icon={<div className="size-full rounded-md flex items-center justify-center bg-purple-500/15 text-purple-500"><Puzzle className="size-4" /></div>}
    title="Apps"
    description="Package and distribute integrations across multiple stores with OAuth-based install flows."
  />
  <Card
    href="/docs/webhooks"
    icon={<div className="size-full rounded-md flex items-center justify-center bg-pink-500/15 text-pink-500"><Webhook className="size-4" /></div>}
    title="Webhooks"
...
- [Storefront GraphQL API](/docs/storefront/api) — fetch products, cart data, and more
...
- [API reference](/docs/admin-api/reference/ordersCreate) — full endpoint reference
