...
```json http-method="GET" http-target="https://{store}.29next.store/api/admin/assigned-fulfillment-orders/?assignment_status=fulfillment_requested"
{}
```
</Tab>
...
```json http-method="GET" http-target="https://{store}.29next.store/api/admin/assigned-fulfillment-orders/?assignment_status=cancellation_requested"
{}
```
...
```json title="Example Fulfillment Accept Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/fulfillment-request/accept/"
{}
```
...
```json title="Example Fulfillment Rejection Payload" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/fulfillment-request/reject/"
{
...
```json title="Retrieve all pending Cancellation Requests" http-method="GET" http-target="https://{store}.29next.store/api/admin/assigned-fulfillment-orders/?assignment_status=cancellation_requested"
{}
```
...
```json title="Example Cancellation Accept Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/cancellation-request/accept/"
{}
```
...
```json title="Example Cancellation Reject Request" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/cancellation-request/reject/"
{
...
```json title="Fulfillment Create Payload" http-method="POST" http-target="https://{store}.29next.store/api/admin/fulfillment-orders/{id}/fulfillments/"
{
...
```json title="Retrieve Stock Records by Location" http-method="GET" http-target="https://{store}.29next.store/api/admin/stockrecords/?location_id={id}"
{}
```
...
```json title="Update Number of Units In Stock" http-method="PATCH" http-target="https://{store}.29next.store/api/admin/stockrecords/{id}/"
{
  "num_in_stock": 1000
}
```
