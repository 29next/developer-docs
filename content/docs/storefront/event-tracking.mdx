...
<Tabs items={['Init Cart (init.cart)', 'Init Store (init.store)', 'Init User (init.user)']}>
<Tab value="Init Cart (init.cart)">
...
<Tab value="Init Store (init.store)">
